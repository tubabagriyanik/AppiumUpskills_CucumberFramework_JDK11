...
// import io.cucumber.java.en.*; when i sildik, * yaptik ki tum importlari gorsun
/*
    Form Sayfasi formSayfasi = new FormSayfasi(); obje olusturunca , formsayfasi class ina gider
     public FormSayfasi() {

        PageFactory.initElements(new AppiumFieldDecorator(Driver.getDriver()), this); bu satiri calistirir, ve locate leri alir.
 */